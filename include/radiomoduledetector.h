...
typedef enum
{
    DETECT_STATE_IDENTIFY = 0,
    DETECT_STATE_GET_MCU_TYPE = 10,
    DETECT_STATE_GET_VERSION = 20,
    DETECT_STATE_GET_HMIP_RF_ADDRESS = 30,
    DETECT_STATE_GET_SGTIN = 40,
    DETECT_STATE_GET_BIDCOS_RF_ADDRESS = 50,
    DETECT_STATE_GET_SERIAL = 60,

    DETECT_STATE_LEGACY_GET_VERSION = 21,
    DETECT_STATE_LEGACY_GET_BIDCOS_RF_ADDRESS = 51,
    DETECT_STATE_LEGACY_GET_SERIAL = 61,
